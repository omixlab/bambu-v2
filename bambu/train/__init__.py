...
def main():
    ...
    argument_parser.add_argument('--input-test', required=True, help="path to CSV file containing testing set generated by bambu-preprocess")
...
def train(input_train, input_test, output, estimators=['rf'], threads=1, time_budget=None, max_iter=None, metric=None, eval_method='auto', retrain_full=False, model_history=False):
    ...
    with open(output+'_classification_report.txt', 'w') as report_writer:
        report_writer.write(json.dumps(report, indent=4))
